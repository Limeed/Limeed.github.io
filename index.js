...
// include: C:\Users\limee\AppData\Local\Temp\tmpv72ec0k_.js
...
// end include: C:\Users\limee\AppData\Local\Temp\tmpv72ec0k_.js
// include: C:\Users\limee\AppData\Local\Temp\tmp50v1c51x.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\Users\limee\AppData\Local\Temp\tmp50v1c51x.js
// include: C:\Users\limee\AppData\Local\Temp\tmpg2a07a0x.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\Users\limee\AppData\Local\Temp\tmpg2a07a0x.js
...
var ASM_CONSTS = {
 ...
 411186: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 411269: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 411338: () => { return window.innerWidth; },  
 411368: () => { return window.innerHeight; }
};
var wasmImports = {
  /** @export */
